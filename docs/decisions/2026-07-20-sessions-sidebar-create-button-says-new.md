...
Decided by: Kyle Seaman (PR #94), reaffirmed by Zezhen Xu (maintainer) on 2026-09-23
Date: 2026-07-20
...
- The header slot is narrow. The translator note in
  ...
  is designed around.
- On 2026-09-23 the maintainer confirmed that the short form is the intended
